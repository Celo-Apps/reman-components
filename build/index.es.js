...
function TextInput(_a) {
    var value = _a.value, onChange = _a.onChange, _b = _a.invalid, invalid = _b === void 0 ? false : _b, _c = _a.placeholder, placeholder = _c === void 0 ? "Enter text" : _c, _d = _a.id, id = _d === void 0 ? "value" : _d, _e = _a.disabled, disabled = _e === void 0 ? false : _e, _f = _a.className, className = _f === void 0 ? "" : _f, _g = _a.theme, theme = _g === void 0 ? "dark" : _g;
    ...
    return (jsxRuntime.exports.jsx("input", { id: id, name: id, type: "text", value: value !== null && value !== void 0 ? value : "", onChange: onChange, disabled: disabled, className: "form-input px-3 py-3 block w-full sm:text-sm sm:leading-5 border-none focus:border-black rounded shadow-sm ring-1 transition duration-500 ease-in-out focus:outline-none disabled:opacity-75 " + themeStyles + " " + (invalid ? "ring-red-600" : "ring-transparent") + " " + className, placeholder: placeholder }, void 0));
}
...
var DefaultButton = function (_a) {
    var title = _a.title, onClick = _a.onClick, type = _a.type, before = _a.before, after = _a.after;
    return (jsxRuntime.exports.jsxs("button", __assign({ type: type, onClick: onClick, className: "border-2 rounded py-2 px-4 flex items-center justify-center" }, { children: [before, title, after] }), void 0));
};
...
export { DefaultButton, styles as Styles, tailwind_config as TailwindConfig, TextInput };
